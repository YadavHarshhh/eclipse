...
export default function Home() {
  ...
  const games = [
    { name: "VANGUARDxBGMI", image: "https://sm.ign.com/t/ign_in/screenshot/default/deepika-padukone-skin-bgmi_d34b.1280.jpg" },
    { name: "ORIONxBGMI", image: "https://sm.ign.com/t/ign_in/screenshot/default/deepika-padukone-skin-bgmi_d34b.1280.jpg" },
    { name: "VANGUARDxVALORANT", image: "https://cmsassets.rgpub.io/sanity/images/dsfx7636/news/c6c50b680c5e1846a9c77f86d5aa357d46584ffe-1920x1080.png" },
    { name: "ORIONxVALORANT", image: "https://cmsassets.rgpub.io/sanity/images/dsfx7636/news/c6c50b680c5e1846a9c77f86d5aa357d46584ffe-1920x1080.png" },
    { name: "VANGUARDxCODM", image: "https://codm.garena.com/static/images/Main-page/P1/main-kv.jpg " },

    { name: "TEKKEN", image: "https://static.bandainamcoent.eu/high/tekken/tekken-8/00-page-setup/TEKKEN8_Header_mobile_2.jpg" },
    { name: "ACHILLES - Gameathon", image: "gamedev5.jpg" },

    { name: "Picture Hunt", image: "high10.webp" },
  ...
  const stats = [
    ...
    { label: "Titles", value: 10 },
    { label: "Worth Prize Pool", value: 136500, prefix: "₹" },
  ...
  const registrationLinks = {
    "TEKKEN": "https://docs.google.com/forms/d/e/1FAIpQLSc-X0ECUeSHF_QLWZ2kYQmkYz9t-SbnC2DFTv_n56ikyGdrog/viewform",
    "VANGUARDxBGMI": "https://docs.google.com/forms/d/e/1FAIpQLScFigranV1gfgp9bVFl7p2vdpAE0xJdok8DsdzBy183rz9vDw/viewform",
    "FIFA": "https://docs.google.com/forms/d/e/1FAIpQLSfF57aW4e3f7Pju6ISLKcZ7fHG-tRUAqaKbtxKNyYwwdybKHQ/viewform",
    "ORIONxVALORANT": "https://docs.google.com/forms/d/e/1FAIpQLSdpZBas4kv1OpCgioQfOOQd10S9bna2JQ8GSQhsbURozM3IpA/viewform",
    "VANGUARDxVALORANT": "https://docs.google.com/forms/d/e/1FAIpQLSfy-URQKRMhmHY4HqcoSA75-526iIJKBxZ6XCyUH1p5gC3V-A/viewform",
    "ACHILLES - Gameathon": "https://docs.google.com/forms/d/e/1FAIpQLSc-nqPJSytMBMwj42vtDzTFKLPKtS-w_nN6Bi4-0aTzr9tdrg/viewform",
    "VANGUARDxCODM": "    https://docs.google.com/forms/d/e/1FAIpQLScq3_hADo2l40b363Azfx2MoySfbNhDsH-SvoLHrDi-aMsp_g/viewform",

    "Picture Hunt": "https://docs.google.com/forms/d/e/1FAIpQLSeUiI0hS3eYdfN9m6fmSycsZYlhtjbAoIZuFK08AerKlJTxog/viewform",
    "ORIONxBGMI": "https://docs.google.com/forms/d/e/1FAIpQLSejnofNEArKetsGKqH0UCSUiPtT10fMDZ4Gj3236iWu-giHgg/viewform",
    "F1": "https://docs.google.com/forms/d/e/1FAIpQLScm2dVRZ15uJOfE5349_J2SEy8WqoGL9XNS09USaLDVeC7CTQ/viewform",
  };
...
<h1 className="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-cyan-500 animate-gradient">
  ...
  `}</style>
          ...
          >
            The Cultural and Techno-Management Fest of Glitch! eSports Society, showcasing the best in gaming and technology.
          </motion.p>
  ...
  About ECLIPSE
            ...
            <div className="space-y-6 text-lg text-gray-300">
              <motion.p
                ...
                viewport={{ once: true }}
              >
Eclipse is the annual Cultural, Techno, and Management Fest of Glitch! eSports Society, Manipal University Jaipur              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                viewport={{ once: true }}
              >
                Bringing together the best of gaming, creativity, and innovation. It’s more than just an eSports event — Eclipse blends high-stakes tournaments with cultural showcases, technical workshops, and management-driven challenges, creating a one-of-a-kind festival experience. From Gamathon, an ultimate marathon of engaging gaming challenges, to the Game Development Workshop that sparks creativity and learning, Eclipse serves as a platform where technology meets art, strategy meets execution, and passion meets community. With its dynamic mix of competition, culture, and collaboration, Eclipse is the stage where ideas come alive and memories are made.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
